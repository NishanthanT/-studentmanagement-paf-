          ...
          <div className="flex justify-between items-start">
            ...
            {user?.role === 'TECHNICIAN' && (
              <button 
                ...
                className={`px-6 py-2.5 rounded-xl font-bold transition-all duration-300 shadow-sm flex items-center gap-2 ${
                  showTechStats 
        ...
        {modules.map((module, index) => {
          const content = (
            <>
              ...
              <span className={`inline-flex items-center justify-center px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase transition-all z-10 border ${
                module.active === 'Manage Users' || module.active === 'Your Details' || module.active === 'View Stats'
